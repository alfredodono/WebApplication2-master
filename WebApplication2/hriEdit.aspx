<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hriEdit.aspx.cs" Inherits="WebApplication2.hriEdit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            <div class="form-row text-center">
                ...
                <div class="form-group col-md-2">
                    <asp:Button ID="btnvolHRI" runat="server" Text="Administrar preguntas 📝" OnClick="btnvolHRI_Click"  class="btn btn-success btn-block" ForeColor="White" />
            ...
            <div class="row">
                ...
                <div class="col-md-5 card">
                    ...
                    <div class="form-group text-center">
                        <h3>Actualizacion de Pegunta</h3>
                        <asp:TextBox  placeholder="Ingrese nueva pregunta" class="form-control" ID="txtUser" runat="server"></asp:TextBox>
                        
                  
                    </div>
                    <asp:FileUpload ID="fuimage" runat="server"  onchange="showpreview(this);" />
                     <small id="imghelp" class="form-text text-muted">si conserva la imagen deje este campo sin foto nueva.</small>
                    ...
                    <div class="text-center justify-content-md-center justify-content-center align-items-center">
                        <div class="card mx-auto">
                            <img id="imgpreview" height="400" width="400" src="A" style="border-width: 0px; visibility: hidden;" />
                             <small id="imgprevie" class="form-text text-muted">preview de la imagen a cargar</small>
                        </div>
                ...
                <div class="col-md-7">
                    ...
                    <div class="text-center" style="height: 500px; width: auto; overflow: auto;">
                        ...
                        <asp:GridView ID="gdvusuarios" DataKeyNames="ID"  OnRowDataBound="OnRowDataBound"  class="thead-dark text-center" ShowHeader="false" CssClass="table table-bordered table-striped " RowHeaderColumn="hola, prros" AutoGenerateColumns="false" runat="server">
